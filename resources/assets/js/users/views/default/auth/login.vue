<template>
    <div class="register">
        ...
        <transition name="slide-fade">
            <div class="login col-12 col-md-6 col-lg-6 col-xl-4 offset-md-5 offset-lg-5 offset-xl-7" v-show="loginShow">
                <div class="login-box">

                    <div class="col-12 login-form" @keyup.enter="login">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-addon icon">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 483.3 483.3"
                                        style="enable-background:new 0 0 483.3 483.3;" xml:space="preserve" width="30px">
                                        <g>
                                            <g>
                                        ...
                                        <g>
                                            <g>
                                                <path d="M387.638,73.144c-26.047,0-47.237,21.19-47.237,47.237s21.19,47.237,47.237,47.237s47.237-21.19,47.237-47.237
                                                            ...
                                                            s22.015,9.876,22.015,22.015S399.777,142.396,387.638,142.396z" fill="#e7e7e7" />
                                            </g>
                                        </g>
                                    </svg>
                        ...
                        <div class="form-group form-inline">
                            <div class="col-12 forget-password">
                                <router-link :to="{name: 'forget_password'}">{{$t('register.forget_password')}}</router-link>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group text-center dark-text">
                            ...
                            <router-link :to="{name: 'plan'}" v-if="!$Helper.getIntGatewayStatus('int_gateway')">{{$t('register.signup')}}</router-link>
                            <router-link :to="{name: 'signup-non-payment'}" v-if="$Helper.getIntGatewayStatus('int_gateway')">{{$t('register.signup')}}</router-link>
